...
这一章的基本思路是，我们要通过使{\it 某些东西}取极小值，得到正确的关于自然的方程。{\it 某些东西}是什么？有一件事是确定的：它不应该在 Lorentz 变换下改变，否则我们会在不同的参考系下得到不同的自然规律。在数学意义上，它意味着我们寻找的这个东西是个标量，依照 Lorentz 群的 \( (0,0) \) 表示作变换。再考虑到自然对简单规律的偏好，我们已经足够导出关于自然的方程了。
